        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReputationScore = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_Papers_PaperId",
                        column: x => x.PaperId,
                        principalTable: "Papers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PaperId_CreatedAt",
                table: "Comments",
                columns: new[] { "PaperId", "CreatedAt" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Papers_AverageRating",
                table: "Papers",
                column: "AverageRating",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_Papers_PublishedAt",
                table: "Papers",
                column: "PublishedAt",
                descending: new bool[0]);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_PaperId_UserId",
                table: "Ratings",
                columns: new[] { "PaperId", "UserId" },
                unique: true);
